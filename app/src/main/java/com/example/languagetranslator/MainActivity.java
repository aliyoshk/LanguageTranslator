...
public class MainActivity extends AppCompatActivity {
    ...
    String[] fromLanguages = {"From", "English", "Afrikaans", "Arabic", "Belarusian", "Bulgrian", "Bengali", "Catalan", "Czech", "Welsh",
    "Hindi", "Urdu"};

    String[] toLanguages = {"To", "English", "Afrikaans", "Arabic", "Belarusian", "Bulgrian", "Bengali", "Catalan", "Czech", "Welsh",
            "Hindi", "Urdu"};
